...
class SuperSmartParkingBoyTest {
    ...
    @Test
    void should_return_park_cars_which_contains_more_empty_position_when_parking_a_car_given_multiple_parking_lots() throws Exception {
        //given
        ...
        //when
        ParkingBoy parkingBoy = new ParkingBoy(parkingLotList, new SuperSmartParkingStrategy());
        parkingBoy.park(car);
        parkingBoy.park(car2);
        parkingBoy.park(car3);

        //then
        assertEquals(2, parkingLot1.getParkedCars());
        assertEquals(1, parkingLot2.getParkedCars());
    }
}
